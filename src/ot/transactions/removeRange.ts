import { ContentState, SelectionState, CharacterMetadata } from "draft-js";
...
function removeRangeFromContentState(
  ...
  var blockMap: any = contentState.getBlockMap();
  ...
  blockMap = blockMap.merge(newBlocks as any).filter(block => !!block);
